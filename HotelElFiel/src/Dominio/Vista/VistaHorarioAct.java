 ...
 */
public class VistaHorarioAct extends javax.swing.JFrame {

    /**
     * Creates new form VistaHorarioAct
     */
    public VistaHorarioAct() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Horario De Actividades");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaHorarioAct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaHorarioAct().setVisible(true);
            }
        });
    }
